...
Item {
    ...
    Kicker.RunnerModel {
        ...
        //runners: new Array("services").concat(plasmoid.configuration.extraRunners) //plasmoid.configuration.useExtraRunners ? new Array("services").concat(plasmoid.configuration.extraRunners) : "services"
