...
PlasmaExtras.ScrollArea {
    ...
    property alias iconSize: repeater.iconSize
    property bool isSquare: false
    property int aCellHeight
    property int aCellWidth: gridView.cellWidth
        ...
        Repeater {
            ...
            delegate: Item {
                ...
                ItemGridView {
                    ...
                    height: Math.ceil(count / Math.floor(width / cellHeight)) * cellHeight
                    //cellWidth:  aCellWidth
                    //cellHeight: aCellHeight//<>cellSize
