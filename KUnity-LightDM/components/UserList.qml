...
ListView {
    ...
    readonly property int userItemWidth: units.gridUnit * 12
    readonly property int userItemHeight: units.gridUnit * 2.2
    ...
    preferredHighlightBegin: width/2 - (units.gridUnit * 4)*2
