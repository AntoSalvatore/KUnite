...
Item {
    ...
    Item {
        ...
        width: isCurrent ? faceSize : faceSize - units.largeSpacing*2.5
        height: width
    ...
    PlasmaComponents.Label {
        id: usernameDelegate
        font.pointSize: Math.max(theme.defaultFont.pointSize + 1)
        anchors {
            left: imageSource.right
            leftMargin: 10
            top: imageSource.top
