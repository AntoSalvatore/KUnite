    ...
    */
    ...
    Input {
        ...
        PlasmaComponents.TextField {
                id: passwordBox
                Layout.fillWidth: true
                placeholderText: "<font color='#cccccc'>" + i18nd("plasma_lookandfeel_org.kde.lookandfeel", "Password") + "</font>"
        ...
        Rectangle{
            ...
            Image {
                ...
                id: loginButton
                source: "assets/login_button.svgz"
                sourceSize: Qt.size(passwordBox.height*1.5, passwordBox.height*1.5)
                smooth: true
                opacity: 1
            }
            MouseArea {
